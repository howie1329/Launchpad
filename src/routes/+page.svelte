...
>
	<header
		class="flex h-14 shrink-0 items-center border-b border-border/50 px-5 sm:px-8"
	>
	...
	<div
		class="mx-auto flex w-full max-w-7xl min-h-0 flex-1 flex-col gap-10 px-5 py-10 sm:px-8 lg:flex-row lg:items-center lg:gap-12 lg:py-6 xl:gap-14"
	>
		<div class="hero-copy flex min-h-0 max-w-xl flex-col justify-center lg:max-w-[min(28rem,42vw)]">
			<Badge variant="secondary" class="mb-4 w-fit text-[11px] font-medium uppercase tracking-wide">
				Solo developers and indie hackers
			</Badge>
			<h1 class="text-balance text-3xl font-semibold tracking-tight sm:text-4xl lg:text-3xl xl:text-4xl">
		...
		>
			...
			>
				<div
					class="flex h-10 shrink-0 items-center justify-between border-b border-border/60 px-3"
				>
					<div class="min-w-0">
						<p class="truncate text-[11px] font-medium text-foreground">Workspace</p>
						<p class="truncate text-[10px] text-muted-foreground">Thread · Drafts apply, not overwrite</p>
					</div>
				...
				<div class="flex min-h-0 flex-1">
					<div
						class="hidden w-[42%] shrink-0 border-r border-border/60 bg-sidebar/50 p-3 sm:block"
					>
						<p
						...
						<div class="space-y-2">
							<div class="rounded-md border border-border/50 bg-accent/40 px-2 py-1.5 text-[11px] text-foreground">
								Idea · Narrow the first user
							</div>
							<div class="rounded-md border border-border/50 bg-accent/30 px-2 py-1.5 text-[11px] text-foreground">
					...
					<div class="flex min-w-0 flex-1 flex-col p-3">
						...
						<div class="space-y-2">
							<div class="rounded-md bg-accent/45 px-2.5 py-2 text-[11px] leading-relaxed text-foreground">
						...
						<div class="mt-auto flex flex-wrap gap-1.5 pt-3">
							<span class="rounded-full bg-secondary/80 px-2 py-0.5 text-[10px] text-secondary-foreground">
								idea
							</span>
							<span class="rounded-full bg-secondary/80 px-2 py-0.5 text-[10px] text-secondary-foreground">
								prd
